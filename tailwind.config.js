...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        parallax: 'url("../src/assets/plomeria/plomeria4-4.png")',
        parallax1: 'url("../src/assets/plomeria/4M.png")',
        parallaxElec: 'url("../src/assets/electricidad/3M.png)',
        ...
        parallaxHC1: 'url("../src/assets/SmartHome/smartHome2.png")',
        parallaxHC2: 'url("../src/assets/SmartHome/smartHome2-2.png")',
        parallaxI: 'url("../src/assets/index/index1.png")',
