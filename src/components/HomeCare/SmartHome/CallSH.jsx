...
import auto from "/src/assets/SmartHome/automatizacion2.jpg";
...
export const CallSH = () => {
  ...
  return (
    <div className="w-full bg-white mt-10 px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 bg-[#F2C00C]/20">
        <div className="">
          <img
        ...
        <div className=" flex flex-col justify-center font-monts px-10 py-8">
          <h2
            className="font-bold lg:text-4xl text-3xl leading-none  py-5 "
            data-aos="fade-down"
          >
