...
export const DiseñoCalderas = () => {
  //Navegacion hacia el Stepper Estudio
  const navigate = useNavigate();
  return (
    <div className="w-full mt-10 mb-16">
      <div className="px-5 md:px-14 ">
        <div className="flex items-center justify-start rounded-3xl w-full h-[480px] bg-fixed bg-parallaxCal bg-cover ">
            ...
            <div className="px-10 h-full flex flex-col justify-center items-center md:items-start">
              ...
              <div className="w-full">
                <p className="text-[14px] md:text-[16px]  lg:text-[18px]  mt-5 mb-5 font-monts leading-tight font-medium flex flex-row items-center text-left text-white">
                  La tecnología de condensación a gas reduce la emisión de gases
                  de efecto invernadero, por lo que se consideran equipos
                  sustentables.
                </p>
              </div>
