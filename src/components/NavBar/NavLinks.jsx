  ...
  const links = [
    {
      ...
      menu: true,
      sublinks: [
        { name: "Eléctricidad", link: "/InicioSesion"   },
        { name: "Plomería", link: "/" },
    ...
    },
    {
      ...
      menu: true,
      sublinks: [
        { name: "Paneles Solares", link: "/Sustentabilidad" },
        { name: "Almacenamiento de Energía", link: "/PanelesSolares" },
    ...
    },
    {
      ...
      menu: true,
      sublinks: [
        { name: "Arrendamiento Solar", link: "/SolicitarEstudio" },
